...
| <a name="nautobot.nginx.image.tag">[nautobot.nginx.image.tag](https://github.com/nautobot/helm-charts/blob/main/charts/nautobot/values.yaml#L268)</a> | string | `"1.26"` | NGINX image tag |
