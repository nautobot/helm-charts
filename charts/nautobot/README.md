...
![Version: 2.5.8](https://img.shields.io/badge/Version-2.5.8-informational?style=flat-square) ![AppVersion: 2.4.20](https://img.shields.io/badge/AppVersion-2.4.20-informational?style=flat-square)
...
| oci://registry-1.docker.io/bitnamicharts | postgresql | 18.1.3 |
...
| <a name="metrics.nginxExporter.image.tag">[metrics.nginxExporter.image.tag](https://github.com/nautobot/helm-charts/blob/main/charts/nautobot/values.yaml#L888)</a> | string | `"1.5.1"` | NGINX Exporter image tag |
...
| <a name="nautobot.image.tag">[nautobot.image.tag](https://github.com/nautobot/helm-charts/blob/main/charts/nautobot/values.yaml#L44)</a> | string | `"2.4.20-py3.11"` | Nautobot image tag, common to all deployments |
